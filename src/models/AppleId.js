...
module.exports = sequelize => {
  const AppleId = sequelize.define(
    'AppleId',
    {
      id: {
      ...
      password: {
        type: DataTypes.TEXT,
        allowNull: false,
        comment: 'Apple账号密码（AES-256-GCM 密文）',
        set(value) {
      ...
      securityQa: {
        ...
        allowNull: true,
        field: 'security_qa',
        comment: '安全问答（JSONB 密文包装）',
        set(value) {
          this.setDataValue('securityQa', encryptJson(value));
        },
        get() {
          return decryptJson(this.getDataValue('securityQa'));
        },
      },
      country: {
