...
internal static class Installer
{
  ...
  public static void Install()
  {
    ...
    try {
      ...
      registry.SetValue("DisplayName", "Apple 订单 AOS 采集器"); registry.SetValue("DisplayVersion", "1.2.1"); registry.SetValue("Publisher", "AppleOrderMgr");
